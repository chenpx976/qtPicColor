...
class ClipboardManager:
    ...
    def has_image() -> bool:
        ...
        try:
            ...
            # 检查多种图像格式
            return (mime_data.hasImage() or 
                    mime_data.hasFormat("image/png") or
                    mime_data.hasFormat("image/jpeg") or
                    mime_data.hasFormat("image/bmp") or
                    mime_data.hasFormat("image/gif"))
        except Exception:
            return False
